...
@available(iOS 14, *)
public struct PHPPhotoPicker: UIViewControllerRepresentable {
    ...
    public class Coordinator: PHPickerViewControllerDelegate {
        private let parent: PHPPhotoPicker
        private let handlePickedImage: (URL) -> Void
        
        init(_ parent: PHPPhotoPicker, handlePickedImage: @escaping (URL) -> Void) {
            self.parent = parent
